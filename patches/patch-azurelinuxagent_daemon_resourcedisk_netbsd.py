...
--- /dev/null	2023-11-23 14:03:47.246491770 +0000
+++ azurelinuxagent/daemon/resourcedisk/netbsd.py	2023-11-23 13:54:10.312171319 +0000
@@ -0,0 +1,113 @@
...
+
+class NetBSDResourceDiskHandler(ResourceDiskHandler):
+    def __init__(self):
+        super(NetBSDResourceDiskHandler, self).__init__()
+        # Fast File System (FFS) is UFS
